...
/**
*/
class ChorusModulatorsAndStatefulnessAudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    ChorusModulatorsAndStatefulnessAudioProcessor();
    ~ChorusModulatorsAndStatefulnessAudioProcessor();
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ChorusModulatorsAndStatefulnessAudioProcessor)
};
