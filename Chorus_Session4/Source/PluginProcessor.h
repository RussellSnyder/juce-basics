...
/**
*/
class Chorus_session4AudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    Chorus_session4AudioProcessor();
    ~Chorus_session4AudioProcessor();
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Chorus_session4AudioProcessor)
};
